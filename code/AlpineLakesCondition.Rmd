...
# Testing
i <- filter(elev_intro, Indicator == 'WHO_MICX_COND')
temp <- filter(elev_intro, elev_intro$Indicator %in% unique(elev_intro$Indicator)[1:8])
...
ggarrange(cond_plots[[1]] + rremove("xlab"), cond_plots[[4]] + rremove("xlab"), cond_plots[[5]], ncol=1, common.legend = TRUE, legend="bottom")
